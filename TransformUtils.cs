namespace computernayGrafika
{
    ...
    public static class TransformUtils
    {
        ...
        /// <summary>
        /// Строит косоугольную проекцию (по умолчанию — кабине, при коэффициенте
        /// искажения distortionFactor = 0.5) для заданной точки зрения.
        /// Соответствует общей матрице косоугольной проекции:
        ///
        ///   [ 1  0  L·cosα  0 ]
        ///   [ 0  1  L·sinα  0 ]     (вид спереди: глубина по Z)
        ///   [ 0  0    0     0 ]
        ///   [ 0  0    0     1 ]
        ///
        /// где L — коэффициент искажения ребер, перпендикулярных плоскости проекции
        /// (для кавалье L = 1, для кабине L = 1/2), а α — угол наклона проекции
        /// оси глубины к горизонтали. Для видов "сверху" и "сбоку" роль оси
        /// глубины играют Y и X соответственно — матрица строится аналогично,
        /// но с переставленными координатами.
        /// </summary>
